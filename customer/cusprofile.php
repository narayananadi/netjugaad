...
<html>
  ...
  <div class="btnmargin " style="width: 30%" >
    
  
  <button class='butt' onclick="btn(1)" > Personal Details</button>
  <button class='butt' onclick="btn(2)" > Update Password </button>
  </div>
<div onload ="onld()">
<form class="form" method="post" name="prsnl" id="prsnl" action="update.php" style="visibility:visible;">
...
<input type="text" name="address" onclick="change(this)"  id="address" placeholder="Address" />
<br><br>
...
<div class="line" style="margin-left: 14%;"></div>
...
<div class="back" > <a href="indexcus.php" >back to home </a></div>
